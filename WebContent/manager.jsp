...
<div id="rightSide">
    ...
    <div class="statsRow">
        <div class="wrapper">
        	<div class="controlB">
            	<ul>
            		<li><a href="${pageContext.request.contextPath}/addplate" title=""><img src="${pageContext.request.contextPath}/static/images/icons/control/32/database.png" alt="" /><span>板块管理</span></a></li>
